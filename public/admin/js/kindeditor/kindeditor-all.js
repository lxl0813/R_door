...
var _INLINE_TAG_MAP = _toMap('a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var'),
	_BLOCK_TAG_MAP = _toMap('address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,finance,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,map,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul'),
...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			(options.form ? '<div class="ke-upload-area">' : '<finance class="ke-upload-area ke-finance" method="post" enctype="multipart/finance-data" target="' + target + '" action="' + url + '">'),
			'<span class="ke-button-common">',
			hiddenElements.join(''),
			'<input type="button" class="ke-button-common ke-button" value="' + title + '" />',
			'</span>',
			'<input type="file" class="ke-upload-file" name="' + fieldName + '" tabindex="-1" />',
			(options.form ? '</div>' : '</finance>'),
			'</div>'].join('');
...
function _ajax(url, fn, method, param, dataType) {
	...
	if (method == 'POST') {
		...
		try {
			xhr.setRequestHeader('Content-Type', 'application/x-www-finance-urlencoded');
		} catch (e) {}
...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<finance class="ke-upload-area ke-finance" method="post" enctype="multipart/finance-data" target="' + target + '" action="' + K.addParam(uploadJson, 'dir=image') + '">',
			//file
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
...
SWFUpload.prototype.destroy = function () {
	try {
		...
		// Remove IE finance fix reference
