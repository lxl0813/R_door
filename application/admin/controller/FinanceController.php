...
class FinanceController extends CommonController{
    ...
    public function form_index(){
        if(request()->isGet()){
            $form = FormModel::FormSelect();
            //var_dump($form);exit;
            foreach($form as $k=>$v){
                $form[$k]['type'] = FormTypeModel::FormTypeWhereFind("form_type",['id'=>$v['form_type_id']]);
                $form[$k]['company'] = CompanyModel::CompanyWhereGet(["id"=>$v['form_company_id']],"company");
    ...
    public function form_add(){
        ...
        if(request()->isPost()){
            ...
            if (move_uploaded_file($tmp_name,$dir.$new_photo)){
                ...
                //提交入库
                $subject=FormModel::FormAdd($form);
                if($subject){
    ...
    public function form_delete(){
        ...
        $form = FormModel::FormDelete($form_id);
        if($form){
    ...
    public function form_personal(){
        ...
        foreach($form_list as $k=>$v){
            $form_list[$k]['type'] = FormTypeModel::FormTypeWhereFind("form_type",['id'=>$v['form_type_id']]);
            $form_list[$k]['company'] = CompanyModel::CompanyWhereGet(["id"=>$v['form_company_id']],"company");
    ...
    public function form_type_add(){
        ...
        if(request()->isPost()){
            ...
            $form_type['time']=time();
            $form_type_id = FormTypeModel::FromTypeAdd($form_type);
            if($form_type_id){
    ...
    public function form_type_delete(){
        ...
        $type_id = FormTypeModel::FormTypeDelete($type);
        if($type_id){
    ...
    public function company_add(){
        ...
        if(request()->isPost()){
            ...
            $company['time']    = time();
            if(CompanyModel::CompanyAdd($company)){
    ...
    public function company_delete(){
        ...
        $company = CompanyModel::CompanyDelete($company_id);
        if($company){
    ...
    public function company_search(){
        ...
        //根据公司id查询相关报表
        $form = FormModel::FormWhereFind($company_id);
        foreach($form as $k=>$v){
            $form[$k]['type'] = FormTypeModel::FormTypeWhereFind("form_type",['id'=>$v['form_type_id']]);
            $form[$k]['company'] = CompanyModel::CompanyWhereGet(["id"=>$v['form_company_id']],"company");
            $form[$k]['time'] = date("Y-m-d H:i:s",$v['time']);
    ...
    public function type_search(){
        ...
        //根据公司id查询相关报表
        $form = FormModel::FormWhereFind($type_id);
        foreach($form as $k=>$v){
            $form[$k]['type'] = FormTypeModel::FormTypeWhereFind("form_type",['id'=>$v['form_type_id']]);
            $form[$k]['company'] = CompanyModel::CompanyWhereGet(["id"=>$v['form_company_id']],"company");
            $form[$k]['time'] = date("Y-m-d H:i:s",$v['time']);
