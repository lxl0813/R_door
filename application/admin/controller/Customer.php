...
use app\admin\model\CustomersMarket;
use app\admin\model\EnquiryOffer;
use app\admin\model\EnquiryType;
use app\admin\model\Market;
use app\admin\model\MarketType;
use app\admin\model\ProductLine;
use app\admin\model\Purchaser;
use app\admin\model\PurchaserEnquiry;
use app\admin\model\SupplierLine;
use app\admin\model\SupplierProducts;
use app\admin\model\SupplierProductsPrice;
use app\admin\model\Suppliers;
use think\Db;
use think\Exception;
...
class Customer extends Common{
    ...
    public function customer_index(){
        ...
        //客户管理
        $customer = (new CustomersMarket())->customerToMarket(['create_admin_id'=>$admin_id]);
        //管理类型查询
        $market_type=MarketType::MarketSelect();
        //最新未过期报价表
        $suppler_offer_price=(new SupplierProductsPrice())->suppler_offer_price(['spp.create_admin_id'=>$admin_id]);
    ...
    public function customer_type_search(){
        ...
        $where=$type+$where;
        $customer = (new CustomersMarket())->customerToMarket($where);
        //采购商询单待报价列表(老样子)
        $enquiry=(new PurchaserEnquiry())->stay_enquiry_search();
        $market_type=MarketType::MarketSelect();
        //最新未过期报价表
        $suppler_offer_price=(new SupplierProductsPrice())->suppler_offer_price();
    ...
    public function offer_price_search_status(){
        ...
        $market_type=MarketType::MarketSelect();
        //报价查询
        $suppler_offer_price=(new SupplierProductsPrice())->offer_price_search_status($data);
    ...
    public function enquiry_offer(){
        ...
        unset($data['price']);
        $enquiry_offer_add = (new EnquiryOffer())->enquiryOfferAdd($data);
    ...
    public function purchaser_enquiry_add(){
        ...
        //化纤无纺规格查询
        $enquiry_type['hx']=EnquiryType::where(['type'=>1])->select();
        $enquiry_type['wf']=EnquiryType::where(['type'=>2])->select();
    ...
    public function purchaser_enquiry_add_do(){
        ...
        if($resout['return']==1){
            ...
            $data['type']=$a;
            $return  = (new Purchaser())->purchaser_enquiry_add($data);
            if($return==1){
    ...
    public function supplier_name_like_search(){
        ...
        $supplier_name=(new Suppliers())->supplier_name_like_search($data);
    ...
    public function supplier_product_search(){
        ...
        $supplier_id['supplier_id'] = (new Suppliers())->supplier_name_search($data);
        if(empty($supplier_id['supplier_id'])){
            echo json_encode(['code'=>500,'msg'=>'对不起！没有查询到该供应商！，请先前往添加供应商！']);return;
        }
        $supplier_product_list=(new SupplierProducts())->supplier_product_search($supplier_id);
    ...
    public function supplier_offer_price_add_do(){
        $data=input("param.");
        $resout = (new SupplierProductsPrice())->supplier_offer_price_add_do($data);
        if($resout==1){
    ...
    public function supplier_offer_price_index(){
        ...
        $offer_price = (new SupplierProductsPrice())->suppler_offer_price($where);
    ...
    public function supplier_offer_price_search_status(){
        ...
        $offer_price = (new SupplierProductsPrice())->offer_price_search_status($data);
        $no="1";
    ...
    public function supplier_index(){
        ...
        $paginate="20";
        $no="1";
        $suplier=(new Suppliers())->supplier_select($where,$paginate);
    ...
    public function supplier_line_suspension_search(Request $request){
        $data=$request->post();
        $supplier_line = (new SupplierLine())->supplier_line_suspension_search($data);
        $content="";
    ...
    public function supplier_product_suspension_search(Request $request){
        $data=$request->post();
        $supplier_product = (new SupplierProducts())->supplier_product_search($data);
        $content="";
    ...
    public function supplier_update_index(){
        ...
        $supplier=(new Suppliers())->supplier_essential_information($data);
    ...
    public function supplier_update_j_do(Request $request){
        ...
        $res = (new Suppliers())->supplier_update($where,$data);
        if($res==1){
    ...
    public function supplier_update_line_do(Request $request){
        ...
        if($data['line_type']==1){
            ...
            unset($line);
            $res = (new SupplierLine())->supplier_line_update_batch($lines);
            if($res==1){
            ...
            $res=(new SupplierLine())->supplier_line_add($lines);
            if($res==1){
    ...
    public function supplier_update_product_do(Request $request){
        ...
        if($data['product_type']==1){
            ...
            unset($line);
            $res = (new SupplierProducts())->supplier_product_update_batch($products);
            if($res==1){
            ...
            $res=(new SupplierProducts())->supplier_product_add($products);
            if($res==1){
    ...
    public function supplier_delete_line_do(Request $request){
        $data = $request->post();
        $res = (new SupplierLine())->supplier_line_delete($data);
        if($res==1){
    ...
    public function supplier_offer_see(){
        $data=input('');
        $res = (new SupplierProductsPrice())->supplier_product_price($data);
    ...
    public function purchaser_index(){
        ...
        $paginate="20";
        $no="1";
        $purchaser = (new Purchaser())->purchaser_information(['create_admin_id'=>$this->admin_id()],$paginate);
    ...
    public function purchaser_update_index(){
        ...
        $purchaser = (new Purchaser())->purchaser_information($data,0);
    ...
    public function purchaser_update_do(){
        $data=input('param.');
        $purchaser = (new Purchaser())->purchaser_update_do($data);
        if($purchaser==1){
    ...
    public function purchaser_enquiry_sees(){
        ...
        $purchaser=(new Purchaser())->purchaser_enquiry_see($data);
        return view('',['purchaser'=>$purchaser]);
    }
    ...
    public function customer_market_add(){
        ...
        $customer=(new CustomersMarket())->customer_information(['id'=>$customer_id],'customer_name',null,1);
        //取管理标签
        $market_type=MarketType::MarketSelect();
    ...
    public function customer_market_add_do(){
        ...
        $resout = (new Market())->market_add($res);
        if($resout==true){
    ...
    public function customer_market_detail_index(){
        $customer_id=input("customer_id");
        $no="1";
        $customer=(new CustomersMarket())->customer_market_all($customer_id);
        $market_type=MarketType::MarketSelect();
    ...
    public function customer_market_update(){
        ...
        $market=(new Market())->customerMarket($customer_id);
    ...
    public function customer_market_update_do(){
        ...
        $resout = (new Market())->market_update($res);
        if($resout==true){
    ...
    public function customer_add_do(Request $request){
        ...
        $data['create_admin_id']=$this->admin_id();
        $data['create_time']=date('Y-m-d H:i:s',time());
        $res = (new CustomersMarket())->customer_add_do($data);
        if($res==true){
